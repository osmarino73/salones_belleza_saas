  ...
  const handlePublishSite = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedBusinessData = {
        ...
        navbar_tagline: businessData?.navbar_tagline || extracted.navbarTagline || undefined,
        business_hours: businessData?.business_hours || (extracted.businessHours ? { summary: extracted.businessHours } : undefined),
        horario_atencion: businessData?.horario_atencion || extracted.businessHours || undefined,
