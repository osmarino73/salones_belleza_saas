...
3. **Hero Inmersivo Móvil: Rostro Despejado Arriba y Textos Centrados del Medio hacia Abajo**:
   - **Fotografía al Fondo con Rostro Libre**: La imagen se expande en el fondo completo (`min-height: 90vh; inset: 0; object-fit: cover; object-position: center 5% !important; opacity: 0.95;`). El rostro, la mirada y el cabello quedan 100% despejados y nítidos en la mitad superior de la pantalla.
   - **Máscara Gradiente de Fusión Suave**: Transparente en la parte superior (0% a 40%) para admirar la foto, y con degradado suave en la parte inferior (70% a 100%) para dar soporte de lectura a los textos.
...
4. **Barra Superior Móvil 100% Transparente sobre la Foto (Limpia, sin Fondos ni Píldoras)**:
   - En móvil (`@media (max-width: 768px)`), la barra superior es **100% transparente y flotante** (`position: absolute; top: 0; left: 0; background: transparent; border: none; box-shadow: none;`).
   - Muestra el **isotipo del salón con su fondo blanco sutil y el nombre de la marca (`SANDRA COLOR´S`) centrado directamente sobre la fotografía de fondo**, integrándose de forma natural y elegante.
   - Sin botones redundantes de agendar ni menús hamburguesa en la cabecera móvil, logrando la máxima pureza visual.
